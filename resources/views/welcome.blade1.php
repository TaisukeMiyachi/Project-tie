...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- <body class="bg-cover bg-repeat" style="background-image: url('/images/landscape-7746822_1280.png')"> -->
        ...
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">手紙を書く（生徒用ログイン）</a>
