    ...
    <div class="mt-0 h-full text-center">
        ...
        <div class="w-full md:w-1/2 mx-auto">
            <label class="w-full h-full block flex justify-center mb-4">
                <textarea class="px-4 py-4 resize-none w-full h-70 md:h-64 block rounded-md shadow-md focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-lg" name="message" type="text" readonly>{{ $message }}</textarea>
            </label>
